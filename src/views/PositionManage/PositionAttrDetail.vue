...
外链，否则将自动删除，不可恢复"
          ...
          <el-form-item prop="workPlace">
            <Map
              ...
              :form-company="jobTypeList.workingPlace"
            />
          </el-form-item>
...
import PositionTagSelector from "./components/PositionTagSelector.vue";
...
const handlePlace = (val: any) => {
  jobTypeList.value.workAreaName = val.address;
  jobTypeList.value.workingPlace = val.location;
};
